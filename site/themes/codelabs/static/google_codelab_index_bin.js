(function () {
     ...
     function sb(a) {
         ...
         for (var c = Math.max(0, Math.ceil(a.length)), d = 0; d < c; d++) {
             var e = d;
             b += '<option value="' + L(a[e]) + '">' + J(a[e]) + "</option>";
         }
         return K(b + "</select></div>");
     }
     var tb = (function (a) {
         var b = !1,
             c;
 ...
 */
     ...
     O.prototype.connectedCallback = function () {
         this.hasAttribute("sort") ? zb(this) : this.setAttribute("sort", "alpha");
         (this.hasAttribute("filter") || this.hasAttribute("category") || this.hasAttribute("tags")) && Ab(this);
     };
     ...
     O.prototype.J = function (a) {
         ...
         (null != l && l.g === Ta) || (null != l && l.g === Ua)
             ? (e = String(l).replace(N, M))
             : l instanceof A
             ? (e = String(Ka(l)).replace(N, M))
             : l instanceof z
             ? (e = String(l instanceof z && l.constructor === z && l.H === Ia ? "" : "type_error:TrustedResourceUrl").replace(N, M))
             : ((e = String(l)), (e = rb.test(e) ? e.replace(N, M) : "about:invalid#zSoyz"));
         c = c(d + L(e) + '">Start</a></div></div>');
         d = yb(c);
         if (c instanceof G)
             if (c.g === Va) c = Qa(c.toString());
             else {
     ...
     function rc(a) {
         ...
         a.j &&
             Y(a.o, a.j, "change", function () {
                 a.i && a.j && a.i.setAttribute("category", a.j.value);
             });
     }
     function sc(a) {
         window.requestAnimationFrame(function () {
